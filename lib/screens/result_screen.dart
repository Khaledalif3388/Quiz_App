...
import '../models/add_question_screen.dart'; // Import the AddQuestionScreen widget
      ...
      body: Center(
        child: Column(
          ...
          children: [
            ...
            ElevatedButton(
              onPressed: () {
                // Navigate to the add question screen
                Navigator.push(
                  context,
                  MaterialPageRoute(
                    builder: (context) => AddQuestionScreen(
                      addQuestion: (question) {
                        // Implement the logic to add the question here
                      },
                    ),
                  ),
                );
